...
def test_plugin_aliases_context_updated():
    ...
    assert calc.chksym("getsym")
    assert calc.chksym("chksym")
    assert calc.chksym("parse_latex")
    assert calc.chksym("parse_maxima")
    assert calc.chksym("parse_mathematica")
    ...
    assert callable(calc.getsym("getsym"))
    assert callable(calc.getsym("chksym"))
    assert callable(calc.getsym("parse_latex"))
    assert callable(calc.getsym("parse_maxima"))
    assert callable(calc.getsym("parse_mathematica"))
...
def test_plugin_aliases_available():
    ...
    assert callable(calc.command("getsym"))
    assert callable(calc.command("chksym"))
    assert callable(calc.command("parse_latex"))
    assert callable(calc.command("parse_maxima"))
    assert callable(calc.command("parse_mathematica"))
